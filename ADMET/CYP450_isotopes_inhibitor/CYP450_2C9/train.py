...
from dataset.cyp450_2c9_data import cyp2c9_dataset
from model.sgc import SGC_network
from sklearn.metrics import r2_score
from torch_geometric.data import DataLoader

path="E:/ind content/bayes_labs_project/deepchem_data/Data_cyp450/data_cyp450_2c9.csv"
dataset=cyp2c9_dataset(path)
print(len(dataset))
...
class Train(object):
    ...
    def __call__(self, *input):
       ...
       for epoch in range(self.epoch):
          ...
          torch.save(self.model, 'E:/ind content/pycharm/office_pro/demo_project/Training/cyp450_2c9.pt')
       test_loader = DataLoader(input[1], batch_size=1, shuffle=False)
       y_hat = [0.0] * len(test_loader)
       y = [0.0] * len(test_loader)
       model = torch.load('E:/ind content/pycharm/office_pro/demo_project/Training/cyp450_2c9.pt')
       model = model.eval()
       count1 = 0
