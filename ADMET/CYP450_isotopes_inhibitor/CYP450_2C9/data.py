...
class cyp2c9_dataset(Dataset):
    def __init__(self, path):
        with open(path) as file:
            ...
            self.data=self.data[['smile_1851', 'p450-cyp2c9-Potency']]
            # self.data=self.data.drop('num_atom', axis=1)
            # self.data=self.data.drop('PUBCHEM_CID', axis=1)
